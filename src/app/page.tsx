...
export default function Home() {
	return (
		<div className="min-h-screen font-sans">
			<Header />
			<main className="flex flex-col items-center justify-center min-h-screen px-8 sm:px-12 py-16 gap-16">
			...
			<footer id="contact" className="py-12 px-8 sm:px-12 text-center flex flex-col gap-4">
